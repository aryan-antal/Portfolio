...
export default function Resume() {
  return (
    <div className="bg-white text-black font-sans leading-relaxed px-6 md:px-20 py-10">
      <section className="project_section">
        ...
        <div className="project_six product_card" >
            <div className="md_wrapper" >
                <div className="project_image">
                    <img src="/Images/Gsp.png" alt =""></img>
                </div>
                <div className="project_about">
            ...
            {/* Secong Project */}
            <div className="project_two product_card" >
                <div className="md_wrapper" >
                    <div className="project_image">
                        <img src="/Images/Rj Lee.png" alt =""></img>
                    </div>
                    <div className="project_about">
                        <h3>RJ Lee</h3>
                        <p>Developed a fully responsive HubSpot CMS website for a scientific laboratory services 
                            provider. Built from scratch as a custom HubSpot theme using HubL, HTML/CSS, and 
                            JavaScript. The project included advanced content modules, animation effects, 
                            blog integration, and responsive design optimized for performance and SEO.</p>
                            <h5>Features:</h5>
                            <ul>
                                <li>Custom HubSpot modules</li>
                                <li>Scroll-based animations and section reveals</li>
                                <li>Modular CMS structure for non-technical editors</li>
                                <li>Blog and resource integration</li>
                            </ul>
                        <div className="button_container">
                            <a href="https://www.rjleegroup.com/" className="cta_Button Arrow_button">
                                 Show Project <span className="text-xl">→</span>
                            </a>
                        </div>
                        <a href="https://www.rjleegroup.com/" className="project_link"></a>
                    </div>
                </div>
            </div>   
            {/* Third Project */}
            <div className="project_three product_card" >
                <div className="md_wrapper" >
                    <div className="project_image">
                        <img src="/Images/Eco.png" alt =""></img>
                    </div>
                    <div className="project_about">
                        <h3>ECO Multistep Calculator</h3>
                        <p>Built a custom HubSpot template for a multistep pricing form designed to calculate 
                            value-based quotes in real-time. The form features dynamic sliders, optional add-ons,
                             and step transitions — optimized for conversion and lead generation.</p>
                        <h5>Features:</h5>
                        <ul>
                             <li>Custom-coded multistep form in HubSpot CMS</li>
                             <li>HubL logic for field conditions</li>
                             <li>Responsive layout and design alignment</li>
                        </ul>
                        
                        <div className="button_container">
                            <a href="https://info.ecosystems.io/education-portal-test-page?hs_preview=RUfpLics-110012639350" className="cta_Button Arrow_button">
                                 Show Project <span className="text-xl">→</span>
                            </a>
                        </div>
                        <a href="https://info.ecosystems.io/education-portal-test-page?hs_preview=RUfpLics-110012639350" className="project_link"></a>
                    </div>
                </div>
            </div>   
            {/* fifth Project */}
